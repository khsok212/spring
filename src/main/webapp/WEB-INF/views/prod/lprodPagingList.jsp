						...
						<div class="text-center">
							<ul class="pagination">
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a href="${cp }/prod/lprodPagingList?page=${param.page-1 }&pagesize=5" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
										</a></li> 
									</c:otherwise>
								</c:choose>
...
<%-- 									><a href="${cp }/userPagingList?page=${page}&pagesize=15">${page }</a></li> --%>
									...
									<c:otherwise>
										<li><a href="${cp }/prod/lprodPagingList?page=${page}&pagesize=5">${page }</a></li>
									</c:otherwise>
									</c:choose>
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a href="${cp }/prod/lprodPagingList?page=${param.page+1 }&pagesize=5" aria-label="Next">
										<span aria-hidden="true">&raquo;</span>
										</a></li> 
									</c:otherwise>
								</c:choose>
